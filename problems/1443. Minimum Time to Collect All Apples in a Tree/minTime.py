...
def minTime(n: int, edges: List[List[int]], hasApple: List[bool]) -> int:
    ...
    - It builds a graph and initializes the seen set to track which nodes have been
      visited.
    - It starts at node = 0, as directed, and traverse the graph recursively. It returns
      when it hits a dead-end node, that is, a node n for which all nodes in graph[n]
    ...
    def dfs(node: int)->int:
        ...
        result = sum(dfs(v) for v in graph[node] if v not in seen)
...
# print(treeFromEdges([[0,2],[0,3],[1,2]])) # {'0': {'2', '3'}, '1': {'2'}}
# print(treeFromEdges([[0,1],[0,2],[1,4],[1,5],[2,3],[2,6]])) # {'0': {'1', '2'}, '1': {'4', '5'}, '2': {'3', '6'}}
# print(treeFromEdges([[0,1],[0,2],[1,4],[1,5],[2,3],[2,6],[4,7],[4,8],[5,9],[5,10],[7,11],[7,12]])) # {'0': {'1', '2'}, '1': {'4', '5'}, '2': {'3', '6'}, '4': {'8', '7'}, '5': {'10', '9'}, '7': {'12', '11'}}
